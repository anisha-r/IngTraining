...
public class ProductStoreServiceTest {
	...
	public void saveProductStoreDetailsPostiveTest() {
		...
		productStoreDto.setStoreRating(3.0);
		...
		String result = productStoreServiceImpl.saveProductStoreDetails(productStoreDto);
	...
	public void storeReviewPositiveTest() {
		...
		Mockito.when(storeReviewRepository.findByStoreId(productStore.getStoreId())).thenReturn(2.0);
		productStoreDto.setStoreRating(4.0);
		listProductStoreDtos.add(productStoreDto);
		List<ProductStoreDto> result = productStoreServiceImpl.storeReview(productId);
